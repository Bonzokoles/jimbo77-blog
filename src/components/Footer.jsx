            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
                    ...
                    <div className="md:col-span-3 space-y-6">
                        <h4 className="text-sm font-bold text-white tracking-wider uppercase">Bądź na Bieżąco</h4>
                        <p className="text-slate-400 text-sm">
                            Dołącz do naszego newslettera, aby być na bieżąco z najnowszymi informacjami o AI, DevOps i technologiach.
                        </p>
                ...
                <div className="pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
                    <div className="text-center md:text-left">
                        <p>© 2026 JIMBO77 AI Social Club. Stworzone z <Heart size={12} className="inline text-red-500 fill-red-500 mx-1" /> i <span className="text-cyan-500">React</span></p>
                        <p className="mt-1">
                            <a href="mailto:JimBoZen@proton.me" className="text-cyan-400 hover:text-cyan-300 transition-colors">
                                JimBoZen@proton.me
                            </a>
                        </p>
                    </div>
